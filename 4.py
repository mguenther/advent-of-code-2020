...
def number_of_valid_passports(rules):
    passport = {}
    nvalid = 0
    for line in open('/home/pi/Documents/AdventOfCode/4.in', 'r'):
        if not line.strip():
...
print "Solution to first part: " + str(number_of_valid_passports(VALIDATION_FOR_FIRST))
print "Solution to second part: " + str(number_of_valid_passports(VALIDATION_FOR_SECOND))